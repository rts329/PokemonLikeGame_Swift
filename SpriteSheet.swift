...
//  SpriteSheet.swift
//
// From https://stackoverflow.com/questions/28008107/using-sprite-sheets-in-xcode
// Example call:
//  let sheet=SpriteSheet(texture: SKTexture(imageNamed: "spritesheet"), rows: 1, columns: 11, spacing: 1, margin: 1)
// where
//  rows, columns = rows, columns of sprites in sprite sheet
//  spacing = # pixels between each frame
//  margin = # pixels between image border and sprite border
